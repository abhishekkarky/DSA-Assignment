...
/* Use DFS to traverse
Add all the vertices traversed to a subgraph list.
If the subgraph list contains the broken node or the source node (0 in this case),
 it means the subgraph is not disconnected, and thus ignore it. Otherwise, add the subgraph to a list of disconnected subgraphs.
